...
def add_circle( points, cx, cy, cz, r, step ):
    ...
    while t < 1:
        ...
        x1 = r * math.cos(2 * math.pi * (t + change)) + cx
        y1 = r * math.sin(2 * math.pi * (t + change)) + cy
...
def add_curve( points, x0, y0, x1, y1, x2, y2, x3, y3, step, curve_type ):
    ...
    while t < 1:
        ...
        fx = (xcoefs[0][0] * pow(t + change, 3)) + (xcoefs[0][1] * pow(t + change, 2)) + (xcoefs[0][2] * (t + change)) + xcoefs[0][3]
        fy = (ycoefs[0][0] * pow(t + change, 3)) + (ycoefs[0][1] * pow(t + change, 2)) + (ycoefs[0][2] * (t + change)) + ycoefs[0][3]
